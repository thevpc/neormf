...
public class BlobConverter extends DataTypeConverter {
    ...
    public Object businessToSQL(Object businessObject) {
        try {
            ...
            return bb == null ? null : new BlobData(bb, businessObject == null ? "null" : businessObject.getClass().getSimpleName());
        } catch (IOException ex) {
            Logger.getLogger(BlobConverter.class.getName()).log(Level.SEVERE, null, ex);
