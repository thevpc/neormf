...
//        DTOMetaData dataInfo = dataContentPrototype.metadata();
...
//            }
//            DTOFieldMetaData dataField = dataInfo.getField(key);
//            if (value != null) {
...
//        return criteria;
    ...
    public static String logQuery(String query, List params) {
                ...
                switch (c) {
                    case '?': {
                        ...
                        if (o == null) {
                            ...
                            sb.append("?<Unknown ").append(o).append(">");
                        }
                        paramPos++;
                        break;
                    }
