 ...
 */
public class DoubleTypeHtmlSupport extends DefaultDataTypeHtmlSupport {
    ...
    public Object convertHtmlStringToObject(String[] s, DataType type, HttpServletRequest request) {
        try {
            return (s[0]==null || s[0].length()==0) ? null : new Double(Double.parseDouble(s[0]));
        } catch (NumberFormatException e) {
            throw new DataException("org.vpc.neormf.commons.types.DoubleType.BadFormat.Message",new Object[]{s[0]});
        }
    }
