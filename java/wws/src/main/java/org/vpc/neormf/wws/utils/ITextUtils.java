package org.vpc.neormf.wws.utils;
...
public final class ITextUtils {
     ...
     * sinon elle sera transformee en new PdfPCell(new Phrase(String.valueOf(e)))
     * @param boxBorder type de Bord (Rectangle.NO_BORDER,Rectangle.BOX, ...)
     * @param boxWidth tageur du bord
     * @param internalPadding espacement interieur
     * @param externalPadding espacement exterieur
    ...
    /**
     * cree une celule vide sans bordure
     ...
     * @return une image du code e barre
     */
    ...
    /**
     * cree un tableau contenant les cellules <code>values</code>
     * @param values les cellules du tableau
     * @param defaultCell cellule par defaut du tableau
     * @return un tableau contenant les cellules specifiees
     */
