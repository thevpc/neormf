 ...
 */
public class IntTypeHtmlSupport extends DefaultDataTypeHtmlSupport {
    ...
    public Object convertHtmlStringToObject(String[] s, DataType type, HttpServletRequest request) {
        try {
            return (s[0]==null || s[0].length()==0) ? null : new Integer(Integer.parseInt(s[0]));
        } catch (NumberFormatException e) {
            throw new DataException("org.vpc.neormf.commons.types.IntType.BadFormat.Message",new Object[]{s[0]});
        }
    }
