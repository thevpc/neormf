 ...
 * @modification on ---- by -----
 */
public class JavaParam implements Cloneable {
    private String comments;
    private String name;
    private String type;
    private boolean isFinal;

    public JavaParam(String name, String type, String comments) {
        this(name, type, comments, false);
    }

    public JavaParam(String name, String type, String comments, boolean isFinal) {
        this.setName(name);
        this.setType(type);
    ...
    public static String toCommaSeparatedString(JavaParam[] javaParams) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof JavaParam) {
            JavaParam p = (JavaParam) obj;
