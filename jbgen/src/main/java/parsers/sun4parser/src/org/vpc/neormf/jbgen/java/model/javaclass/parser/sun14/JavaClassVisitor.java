...
//        throw exception;
    ...
    public void visitClassDef(Tree.ClassDef classdef) {
        ...
        printFlags(classdef.flags & -513L);
        jbgenJavaClassSource.setModifiers(getPrintFlags(classdef.flags & -513L));
        Name name = enclClassName;
        enclClassName = classdef.name;
        if ((classdef.flags & 512L) != 0L) {
            ...
            /*-JBGEN-*/ jbgenJavaClassSource.setName(classdef.name.toString());
            if (classdef.extending != null) {
                print(" extends ");
                printExpr(classdef.extending);
                /*-JBGEN-*/ jbgenJavaClassSource.setSuperClass(classdef.extending.toString());
            }
            if (classdef.implementing.nonEmpty()) {
                print(" implements ");
    ...
    public void visitMethodDef(Tree.MethodDef methoddef) {
        ...
        println();
        align();
        /*-JBGEN-*/ JavaMethod jbgenJavaMethod = new JavaMethod();
        jbgenJavaClassSource.addMethod(jbgenJavaMethod);
        /*-JBGEN-*/jbgenJavaMethod.setComments((String) docComments.get(methoddef));
        printDocComment(methoddef);
        jbgenJavaMethod.setModifiers(getPrintFlags(methoddef.flags));
        printFlags(methoddef.flags);
        if (methoddef.name == methoddef.name.table.init) {
            /*-JBGEN-*/jbgenJavaMethod.setName(enclClassName == null ? methoddef.name.toString() : enclClassName.toString());
            print(enclClassName == null ? methoddef.name.toString() : enclClassName.toString());
        } else {
            /*-JBGEN-*/jbgenJavaMethod.setType(methoddef.restype.toString());
            /*-JBGEN-*/jbgenJavaMethod.setName(methoddef.name.toString());
