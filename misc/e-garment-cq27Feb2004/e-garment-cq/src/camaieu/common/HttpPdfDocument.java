...
/**
 * Classe de base pour la g�n�ration des documents pdf
 * sur un flux HTTP
 *
...
public abstract class HttpPdfDocument {
    ...
    /**
     * vrai si le flux de sortie doit �tre ferm� � la fin
     */
...
//    }
    ...
    /**
     * m�thode � d�finir pour le contenu du document.
     * par exemple
     * <code>
    ...
    /**
     * m�thode � invoquer pour cr�er le document dans un fichier
     * @param file
     * @throws IOException
     * @throws DocumentException
     */
    ...
    /**
     * m�thode � invoquer pour cr�er le document directement sur le flux http
    ...
    public void build(HttpServletRequest request, HttpServletResponse response) throws IOException, DocumentException {
        ...
        // pour contourner ce 'bug?' je cr�e un fichier temporaire puis je l'efface
