...
public class ErrorList implements Serializable {
    /**
     * liste ordonnée des messages d'erreurs
     */
    private Vector ordredErrors;

    /**
     * ensemble utilisé pour éliminer les duplicata
     */
    private HashSet set;

    /**
     * Creer une nouvelle liste d'erreurs
     * @param noDuplicates si vrai, les message dupliqués seront éliminés automatiquement
     */
