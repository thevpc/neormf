...
public class SimpleFileNameGenerator implements FileNameGenerator{
    /**
     * modele de génération, {timestamp} sera remplacé par la datedu jour au format yyyyMMddHHmmssSSS
     */
    private String pattern;

    /**
     * constructeur
     * @param pattern modèle du nom de fichier
     */
